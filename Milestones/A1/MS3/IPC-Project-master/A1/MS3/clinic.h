...
#define MIN_DAYS_IN_MONTH 30
#define DAYS_IN_NONLEAP_MONTH 28
#define DAYS_IN_LEAP_MONTH 29
#define FIRSTDAY 1
#define STARTING_MONTH 1
#define ENDING_MONTH 12
#define MAX_HOUR 23
#define MIN_HOUR 0
#define MIN_MINUTE 0
...
int verifyTimeSlot(const struct Date date, const struct Time time,
    const struct Appointment* App, int MaxAppointments);
